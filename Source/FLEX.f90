...
!!!!!!!!!!!!!!!!!!!! ENGINE OF PROGRAM  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    do while (deviation.gt.tolerance)
        ...
        WB2(:)=exp(-alpha(:)-U2(:))
        if (iter.gt.1) then
        	WB1(1:L1)=exp(-alpha(1:L1)-U1(1:L1)-Uext1)
        	WB2(1:L2)=exp(-alpha(1:L2)-U2(1:L2)-Uext2)
        endif
        ...
        call forward_propagate(N1,lambda_1b,lambda_1p,lambda_1s,WB1,Gf1)
        call back_propagate(N1,lambda_1b,lambda_1p,lambda_1s,WB1,Gb1)
        call forward_propagate(N2,lambda_2b,lambda_2p,lambda_2s,WB2,Gf2) 
