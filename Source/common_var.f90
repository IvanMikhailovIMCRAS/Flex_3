module common_var		
	...
	integer(4) :: L1           ! - length of external potential (chain 1)
	integer(4) :: L2           ! - length of external potential (chain 2)
	...
	real(8) :: Uext1         ! - value of external potential (chain 1)
	real(8) :: Uext2         ! - value of external potential (chain 2)
